      ...
      <div>
        ...
        {user ? (
          <>
            ...
            <button className="bg-yellow-500 w-full flex gap-1 items-center justify-center py-2.5 text-white rounded-xl rounded">
            ...
            {showOTP ? (
              <>
                ...
                <p className="text-center leading-normal text-gray-400 font-medium text-md mb-10 ">
                  An OTP is sent to +
                  {ph.substring(0, 2) + " " + ph.substring(2, ph.length)}
                  <br />
                  <a
                    href="/"
                    className="text-center border-b-2 border-yellow-500 text-yellow-500 font-medium text-xs p-0 text-decoration-dashed"
                  >
                    Change Phone Number
                  </a>
                </p>
